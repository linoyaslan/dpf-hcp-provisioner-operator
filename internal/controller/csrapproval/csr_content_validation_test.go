...
var _ = Describe("CSR Validation", func() {
	...
	Describe("ValidateServingCSR", func() {
		Context("When CSR has valid serving configuration", func() {
			It("should pass validation", func() {
				hostname := "dpu-worker-01"
				csrBytes := createServingCSRWithDNS("system:node:"+hostname, "system:nodes", hostname)
		...
		Context("When CSR has wrong hostname in DNS SAN", func() {
			It("should fail validation", func() {
				hostname := "dpu-worker-01"
				csrBytes := createServingCSRWithDNS("system:node:"+hostname, "system:nodes", "wrong-hostname")
